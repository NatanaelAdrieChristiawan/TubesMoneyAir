...
/// Implements Contemporary Financial Minimalism design approach with Professional Warmth Palette.
class AppTheme {
  AppTheme._();

  // Professional Warmth Palette - Color Specifications
  ...
  // Dark theme colors maintaining professional warmth
  ...
  static const Color successLightBg =
      Color(0xFFD1FAE5); // Gentle green background
  static const Color warningLightBg =
      Color(0xFFFEF3C7); // Soft yellow background

  static const Color textPrimaryDark = Color(0xFFF8FAFC);
  static const Color textSecondaryDark = Color(0xFF94A3B8);
  static const Color borderDark = Color(0xFF334155);
  static const Color successDarkBg = Color(0xFF064E3B);
  static const Color warningDarkBg = Color(0xFF92400E);
  ...
  // Shadow colors for adaptive card elevation
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme(
      ...
      tertiaryContainer: warningLightBg,
    ...
    // AppBar theme for trust-building professional interface
    ...
    // Card theme with adaptive elevation (2-4dp)
    ...
    // Bottom navigation for mobile-first users
    ...
    // Contextual action buttons with morphing states
    ...
    // Typography for financial data clarity
    textTheme: _buildTextTheme(isLight: true),

    // Input decoration for contextual bottom sheets
    ...
    // Interactive elements for financial controls
    ...
    // List tile theme for transaction lists
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    colorScheme: ColorScheme(
      ...
      tertiaryContainer: warningDarkBg,
  ...
  /// Helper method to get JetBrains Mono text style for financial data
  ...
  /// Helper method to get warning background color based on theme
  static Color getWarningBackgroundColor(bool isLight) {
    return isLight ? warningLightBg : warningDarkBg;
  }

  /// Helper method to get success background color based on theme
  static Color getSuccessBackgroundColor(bool isLight) {
    return isLight ? successLightBg : successDarkBg;
  }
}
